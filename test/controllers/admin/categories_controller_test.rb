...
class Admin::CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_category" do
    assert_difference("Admin::Category.count") do
      post admin_categories_url, params: { admin_category: { session: @admin_category.session, title: @admin_category.title } }
    end
  ...
  test "should update admin_category" do
    patch admin_category_url(@admin_category), params: { admin_category: { session: @admin_category.session, title: @admin_category.title } }
